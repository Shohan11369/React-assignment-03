...
function SearchResult() {
  ...
  return (
    <div className="flex max-w-7xl mx-auto mt-6 gap-6 px-4">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="relative">
            ...
            {/* Dropdown Box */}
            {showBox && (
              <div className="absolute top-full right-0 w-64 bg-white border border-gray-300 rounded-md shadow-lg z-[9999] mt-2">
        ...
        {restaurants.map((r, i) => (
          <div
            key={i}
            className="flex gap-4 border-b pb-4 items-start hover:bg-gray-50"
          >
            {/* Image */}
            <img
              src={r.image}
      ...
      {/* Right Map */}
      <div className="w-1/2 h-[750px] sticky top-20">
        <iframe
          title="map"
